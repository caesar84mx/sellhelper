...
VALUES ('Рога & Копыта, Инк.', 'тел.: +7(988)000-00-00', 1);

INSERT INTO clients (name, middle_name, last_name, contacts, user_id)
VALUES ('Васисуалий', 'Модестович', 'Пупкин', 'skype: pupkin-vas-mod', 1);

INSERT INTO addresses (country, region, location, details, user_id)
VALUES ('Россия', 'Ставропольский край', 'г.Пятигорск', 'ул.Фучика 10, кв. 1', 1);

INSERT INTO goods (name, serial_no, description, user_id, provider_id, price)
VALUES ('Пятикрылый семихуй', '001234', 'Пятикрылый семихуй, сиреневый, сборный', 1, 1, 50000);
